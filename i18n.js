...
(function () {
  ...
  function injectToggle() {
    ...
    var css = '' +
      '.kd-lang-toggle{position:fixed;top:52px;left:50%;transform:translateX(-50%);z-index:99998;display:flex;background:rgba(255,248,236,0.96);' +
      ...
      '@media(max-width:600px){.kd-lang-toggle{top:58px}.kd-lang-toggle button{padding:7px 14px;font-size:12px}}';
