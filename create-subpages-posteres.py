...
pages = [
    ("arte-mural-posteres-mate-premium.html", "Póster Papel Mate Prémium", "Papel Mate Premium"),
    ("arte-mural-posteres-mate-clasico.html", "Póster Papel Mate Clásico", "Papel Mate Clasico"),
    ("arte-mural-posteres-mate-museo.html", "Póster Papel Mate Calidad Museo", "Mate Calidad Museo"),
    ("arte-mural-posteres-impresion-artistica.html", "Póster Impresión Artística (de papel)", "Impresion Artistica"),
    ("arte-mural-posteres-semibrillante-premium.html", "Póster Papel Semibrillante Prémium", "Semibrillante Premium"),
    ("arte-mural-posteres-semibrillante-clasico.html", "Póster Papel Semibrillante Clásico", "Semibrillante Clasico"),
]
...
<header class="page-header">
  <div class="page-header-inner">
    ...
    <p class="page-sub">
      Página vacía. Lo añadimos despacio.
    </p>
  </div>
</header>
