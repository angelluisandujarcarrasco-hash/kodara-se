"""
Aplica precios CON ENVÍO INCLUIDO (margen 50%) a los 5 formularios de Marco de Metal.
NOTA: solo 27 tamaños (sin 75x100 cm ni A0).
También actualiza badges 'Desde $X' del catálogo arte-mural-marco-metal.html
"""
import os
import re
import sys
...
products = [
    {
        "key": "mate-premium",
        "card_text": "Mate Prémium con Marco de Metal",
        "costo_min": 21.02, "costo_max": 104.69,
    },
    {
        "key": "mate-clasico",
        "card_text": "Mate Clásico con Marco de Metal",
        "costo_min": 16.28, "costo_max": 95.55,
    },
    {
        "key": "mate-museo",
        "card_text": "Mate Calidad Museo con Marco de Metal",
        "costo_min": 25.54, "costo_max": 114.69,
    },
    {
        "key": "semibrillante-premium",
        "card_text": "Semibrillante Prémium con Marco de Metal",
        "costo_min": 20.81, "costo_max": 94.01,
    },
    {
        "key": "semibrillante-clasico",
        "card_text": "Semibrillante Clásico con Marco de Metal",
        "costo_min": 15.71, "costo_max": 94.28,
    },
]
...
# Solo 27 posiciones (sin 75x100 cm ni A0 que están en posiciones 27 y 28)
posiciones_27 = [
    0.00, 0.02, 0.05, 0.05, 0.05, 0.08,
    0.12, 0.13, 0.16, 0.20, 0.20, 0.24, 0.28, 0.32,
    0.37, 0.42, 0.47, 0.50, 0.55, 0.59, 0.62, 0.68,
    0.74, 0.78, 0.84, 0.87, 0.92,
]

# 27 tamaños (sin 75x100 ni A0)
size_defs_27 = [
...
# Cargar catálogo
catalogo_path = os.path.join(OUT_DIR, "arte-mural-marco-metal.html")
...
for prod in products:
    ...
    filename = f"pedido-marco-metal-{prod['key']}.html"
    ...
    new_stepsub = f'<p class="step-sub">El tamaño final del póster con marco de metal que recibirás. Disponibles 27 tamaños desde ${pmin} hasta ${pmax}.</p>'
...
with open(catalogo_path, "w", encoding="utf-8") as f:
    f.write(cat)
print("OK arte-mural-marco-metal.html (badges actualizados)")

print("\nDONE — 5 paginas de pedido + catálogo Marco de Metal con precios margen 50%")
