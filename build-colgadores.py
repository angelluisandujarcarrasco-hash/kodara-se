...
<title>Pósteres con colgadores · Kodara Print Studio</title>
...
.sub-card-title{font-size:14px;font-weight:800;letter-spacing:-0.3px;line-height:1.3;text-align:center}
...
<header class="page-header">
  <div class="page-header-inner">
    <div class="page-tag">Arte Mural · Pósteres con colgadores</div>
    <h1 class="page-title">
      Personaliza tu <span class="grad">póster con colgador</span>.
    </h1>
    <p class="page-sub">
      Pósters con colgador de madera natural y cordón de cuero. Listos para colgar — sin marcos, sin clavos.
    </p>
  </div>
</header>
