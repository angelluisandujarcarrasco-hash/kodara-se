...
center(d, "USA EL CODIGO", box_y + 35, F_REG(28), (255, 248, 230))
...
center(d, "Envio a todo el mundo", int(H * 0.60), F_REG(36), TEXT_DARK)
center(d, "Sin minimos  -  Calidad premium", int(H * 0.66), F_REG(30), TEXT_SOFT)
